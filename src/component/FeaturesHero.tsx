    ...
    return (
        <div className="w-full flex justify-center items-center mx-auto flex-row" style={{
            ...
            <div className="flex flex-wrap flex-row justify-center w-full mx-auto  max-w-[clamp(1px,73.8888888889vw,1064px)] mb-10" >
                <div id="card1" className="relative bg-blue-200 rounded-2xl px-2 py-2 w-2/3 border border-blue-900 opacity-30">
                ...
                <div id="card2" className="relative bg-purple-200 rounded-2xl px-2 py-2 w-1/3 border border-red-600 opacity-30">
                ...
                <div id="card3" className="relative bg-red-200 rounded-2xl px-2 py-2 w-1/3 border border-green-600 opacity-30">
                ...
                <div id="card4" className="relative  w-2/3 ">
                    <div className="bg-green-200 rounded-2xl px-2 py-2 border border-purple-600 opacity-30">
                    ...
                    <div className="bg-cyan-200 rounded-2xl px-2 border border-red-600 justify-center items-center flex flex-col opacity-30">
